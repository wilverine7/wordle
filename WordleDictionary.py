...
FIVE_LETTER_WORDS_ITALIAN = [
    "abbia", "abile", "abiti", "abito", "about", "abusi", "abuso", 
    "acciò", "acidi", "acido", "acqua", "acque", "acuta", "acute", 
    "acuto", "adamo", "adige", "aerea", "aerei", "aereo", "after", 
    "agire", "agito", "ainsi", "aiuta", "aiuti", "aiuto", "alcun", 
    "aliis", "altra", "altre", "altri", "altro", "amare", "amata", 
    "amato", "amava", "amica", "amici", "amico", "amore", "amori", 
    "ampia", "ampie", "ampio", "anche", "ancor", "andar", "andrà", 
    "anglo", "anima", "anime", "animi", "animo", "annua", "annuo", 
    "ansia", "aosta", "après", "arabi", "arabo", "arch.", "archi", 
    "asilo", "assai", "atene", "atomi", "atque", "attua", "aussi", 
    "autem", "autre", "avait", "avere", "avete", "aveva", "avevo", 
    "avoir", "avrei", "avuta", "avuti", "avuto", "avvio", "azoto", 
    "bacio", "bagno", "balbo", "ballo", "banca", "banco", "banda", 
    "bande", "bando", "barba", "barca", "bassa", "basse", "bassi", 
    "basso", "basta", "basti", "bella", "belle", "belli", "bello", 
    "bensì", "bocca", "boll.", "bolla", "bollo", "bombe", "bontà", 
    "bordo", "borgo", "borsa", "bosco", "brani", "brano", "bravo", 
    "breve", "brevi", "bruno", "buona", "buone", "buoni", "buono", 
    "busta", "busto", "cadde", "caffè", "calce", "calda", "caldo", 
    "calma", "cambi", "campi", "campo", "canta", "canti", "canto", 
    "capua", "carlo", "carne", "carni", "carri", "carro", "carta", "carte", 
    "cass.", "cassa", "casse", "causa", "cause", "cella", "celle", "celui", 
    "cenni", "cenno", "cento", "c'era", "cerca", "cercò", "certa", "certe", 
    "certi", "certo", "cessa", "c'est", "cette", "ch'io", "cicli", "ciclo", "cieca", "cieco", 
    "cieli", "cielo", "cifra", "cifre", "cinta", "circa", "città", "clero", "clima", "cogli", 
    "colla", "colle", "colli", "collo", "color", "colpa", "colpe", "colpi", "colpo", "colta",
    "colto", "colui", "com'è", "comm.", "comma", "comme", "commi", "conf.", "conta", "conte",
    "conti", "conto", "copia", "copie", "copre", "corda", "corde", "corpi", "corpo", "corre", 
    "corsa", "corse", "corsi", "corso", "corte", "corti", "corto", "cos'è", "cost.", "costa", 
    "coste", "costi", "costo", "creda", "crede", "credo", "crisi", "croce", "culti", "culto", 
    "cuneo", "cuore", "cuori", "curia", "curva", "curve", "dagli", "dalla", "dalle", "dallo", 
    "dando", "danni", "danno", "dante", "danza", "darne", "darsi", "david", "dazio", "debba", 
    "debbo", "degli", "degna", "degne", "degni", "degno", "delia", "dell'", "della", "delle", 
    "delli", "dello", "dente", "denti", "desse", "detta", "dette", "detti", "detto", "dicti", 
    "dicto", "dieci", "diede", "diego", "dieta", "direi", "dirlo", "dirsi", "disco", "disse", 
    "dissi", "ditta", "dogma", "dolce", "dolci", "donde", "donna", "donne", "doria", "dorso",
    "dott.", "dotti", "dotto", "dovea", "dover", "dovrà", "droit", "dubbi", "duomo", "ebrei", 
    "ebreo", "edito", "einer", "elena", "entra", "entre", "entro", "entrò", "eorum", "epoca", 
    "erano", "erasi", "erede", "eredi", "esame", "esami", "esige", "esiti", "esito", "esser", 
    "était", "etere", "etiam", "etica", "etico", "extra", "fabio", "facce", "facto", "faire", 
    "fallo", "falsa", "false", "falsi", "falso", "fango", "fanno", "fanti", "farci", "farla", 
    "farle", "farli", "farlo", "farmi", "farne", "farsi", "farvi", "fasce", "fasci", "fatta", 
    "fatte", "fatti", "fatto", "ferma", "fermi", "fermo", "ferri", "ferro", "festa", "feste", 
    "feudo", "fiato", "fibre", "fiera", "fieri", "figli", "fiore", "fiori", "firma", "first", "fissa", "fisse", "fissi", "fisso", "fitta", "fitto", "fiume", "fiumi", "fogli", "folla", "folle", "fonda", "fondi", "fondo", "fonte", "fonti", "forlì", "forma", "forme", "forno", "forse", "forte", "forti", "forza", "forze", "fossa", "fosse", "fossi", "frase", "frasi", "frate", "frati", "freno", "freud", "frode", "fuoco", "fuori", "furia", "furon", "furto", "fusse", "gaeta", "galli", "gallo", "gamba", "gambe", "gamma", "genio", "gente", "genti", "germe", "germi", "gesti", "gesto", "getto", "gioco", "gioia", "giova", "giove", "giust", "globo", "golfo", "gomma", "gradi", "grado", "grand", "grani", "grano", "grato", "grave", "gravi", "greca", "greci", "greco", "grida", "grido", "guida", "guido", "guisa", "gusti", "gusto", "hanno", "hegel", "henry", "homme", "iddio", "india", "infra", "inizi", "inter", "invio", "ipsum", "isola", "isole", "italo", "italy", "iuris", "james", "laghi", "laica", "laici", "laico", "larga", "largo", "larve", "lasci", "latte", "laura", "lazio", "lecce", "legge", "leggi", "leghe", "legno", "lembo", "lenin", "lenta", "lente", "lenti", "lento", "leone", "letta", "letti", "letto", "leurs", "liber", "libia", "libri", "libro", "lieto", "lieve", "lievi", "linea", "linee", "lione", "lista", "liste", "livio", "lordo", "lotta", "lotte", "louis", "lucca", "lucia", "lucio", "luigi", "luisa", "lunga", "lungi", "lungo", "luogo", "lusso", "lutto", "madre", "madri", "mafia", "magia", "magno", "malta", "mamma", "manca", "mancò", "manda", "mandò", "marca", "marco", "maria", "marie", "mario", "marmi", "marmo", "marzo", "mass.", "massa", "masse", "mauro", "media", "medie", "medio", "mensa", "mente", "menti", "mento", "merce", "mercè", "merci", "messa", "messe", "messi", "messo", "metri", "metro", "mette", "mezza", "mezzi", "mezzo", "miele", "mille", "minor", "mista", "misto", "moins", "molle", "molli", "molta", "molte", "molti", "molto", "monde", "mondi", "mondo", "mons.", "monte", "monti", "monza", "morbo", "morta", "morte", "morti", "morto", "mosca", "mossa", "mosse", "mosso", "motto", "multa", "muore", "muove", "musei", "museo", "mutuo", "narra", "nasce", "negli", "negri", "nella", "nelle", "nello", "nervi", "nervo", "nesso", "n'est", "netta", "netto", "nicht", "niuno", "nizza", "nobis", "nonna", "nonno", "norma", "norme", "notai", "notre", "notte", "notti", "nozze", "nulla", "nullo", "nuova", "nuove", "nuovi", "nuovo", "occhi", "odore", "offre", "oltre", "ombra", "ombre", "omero", "omnes", "omnia", "onere", "oneri", "onore", "onori", "opera", "opere", "orale", "ormai", "ossia", "other", "ovest", "ovvio", "padre", "padri", "paese", "paesi", "palla", "panni", "paola", "paolo", "parco", "paris", "parla", "parli", "parlo", "parlò", "parma", "parmi", "parso", "parte", "parti", "partì", "parto", "parve", "passa", "passi", "passo", "passò", "pasta", "patti", "patto", "paura", "pavia", "pegno", "pelle", "penna", "pensa", "pensi", "penso", "pensò", "perde", "perso", "pesca", "pesce", "pesci", "peste", "peter", "petto", "pezzi", "pezzo", "piace", "piana", "piani", "piano", "piede", "piedi", "piega", "piena", "piene", "pieni", "pieno", "piero", "pietà", "place", "plebe", "poche", "pochi", "poema", "poeta", "poeti", "point", "polso", "pompa", "ponte", "ponti", "porre", "porsi", "porta", "porte", "porti", "porto", "portò", "possa", "posso", "posta", "poste", "posti", "posto", "poter", "potrà", "pozzo", "praga", "prati", "prato", "preda", "pregi", "prego", "preme", "premi", "pres.", "presa", "prese", "presi", "preso", "press", "presu", "prete", "preti", "prima", "prime", "primi", "primo", "priva", "prive", "privi", "privo", "prof.", "prole", "prosa", "prova", "prove", "pugno", "punta", "punte", "punti", "punto", "quale", "quali", "quasi", "quell", "quest", "qu'il", "quivi", "qu'on", "quota", "quote", "radio", "raggi", "rango", "ratio", "razza", "razze", "reale", "reali", "reati", "reato", "regge", "regia", "regio", "regni", "regno", "reich", "renda", "rende", "renzo", "rerum", "resta", "resti", "resto", "restò", "retro", "retta", "rette", "retto", "revue", "ricca", "ricci", "ricco", "righe", "ritmi", "ritmo", "rocca", "rocce", "rocco", "roman", "rossa", "rosse", "rossi", "rosso", "rotta", "rotto", "ruoli", "ruolo", "ruota", "ruote", "russa", "russi", "russo", "sacco", "sacra", "sacre", "sacri", "sacro", "saggi", "saint", "saldo", "salto", "salva", "salvo", "sanno", "santa", "santi", "santo", "saper", "sardo", "sarei", "scala", "scale", "scavi", "scavo", "scena", "scene", "scopi", "scopo", "scudi", "scudo", "scuro", "scusa", "secca", "secco", "sedia", "segna", "segni", "segno", "segue", "seguì", "senno", "sensi", "senso", "sente", "senti", "sentì", "sento", "senza", "seppe", "s'era", "seria", "serie", "serio", "serra", "serva", "serve", "servi", "servo", "sessi", "sesso", "sesto", "setta", "sette", "sfera", "sfere", "sfida", "siamo", "siano", "siasi", "sicut", "siede", "siena", "sieno", "siero", "siete", "simon", "siria", "sisto", "smith", "socio", "sodio", "sofia", "sogni", "sogno", "solco", "soldi", "soldo", "somma", "somme", "sommo", "sonno", "sopra", "sorge", "sorta", "sorte", "sorti", "sorto", "sosta", "sotto", "sovra", "spada", "spazi", "spera", "spero", "spesa", "spese", "sport", "sposa", "sposi", "sposo", "stadi", "stare", "stata", "state", "stati", "stato", "stava", "stile", "stili", "stima", "studi", "study", "sugli", "sulla", "sulle", "sullo", "suole", "suolo", "suona", "suoni", "suono", "super", "supra", "tagli", "tamen", "tanta", "tante", "tanti", "tanto", "tappa", "tappe", "tarda", "tardi", "tardo", "tasca", "tassa", "tasse", "tassi", "tasso", "tempi", "tempo", "temps", "tenda", "tende", "tener", "tenga", "tenne", "tenta", "tentò", "tenue", "terra", "terre", "terza", "terzi", "terzo", "testa", "teste", "testi", "testo", "tetto", "their", "there", "these", "those", "tiene", "tinte", "tocca", "tolta", "tolto", "tomba", "tombe", "torna", "tornò", "torre", "torri", "torto", "tosto", "toute", "trama", "treno", "trib.", "tribù", "trono", "trova", "trovi", "trovo", "trovò", "turco", "turno", "tutta", "tutte", "tutti", "tutto", "udine", "udire", "udito", "ultra", "umana", "umane", "umani", "umano", "umile", "umili", "umore", "under", "unica", "unici", "unico", "unita", "unità", "unite", "uniti", "unito", "univ.", "usano", "usare", "usata", "usate", "usati", "usato", "usque", "utile", "utili", "valga", "valle", "valli", "vanno", "varia", "varie", "varii", "vario", "vasta", "vaste", "vasti", "vasto", "veder", "vedrà", "venga", "venir", "venne", "venti", "vento", "verbo", "verde", "verdi", "verga", "verrà", "versi", "verso", "veste", "vesti", "vetri", "vetro", "video", "viene", "vieta", "villa", "ville", "vinti", "vinto", "viola", "virtù", "virus", "visse", "vista", "viste", "visti", "visto", "vizio", "voler", "volge", "volle", "volta", "volte", "volti", "volto", "vorrà", "vuole", "vuota", "vuoti", "vuoto"
